...
public class SnitchListsTable extends TableTopGui<SnitchList> {
    ...
    public SnitchListsTable(GuiScreen parentScreen, Collection<SnitchList> items, String title, boolean fullList,
                            final SnitchManager manager, final Settings settings) {
    ...
    public void saveColumns(List<TableColumn<SnitchList>> allColumns, List<TableColumn<SnitchList>> renderColumns) {
        ...
        settings.setSnitchListColumns(list);
    ...
    public void actionPerformed(GuiButton button) {
        ...
        if (button.id == firstId) { //New snitch list
            Minecraft.getMinecraft().displayGuiScreen(new NewSnitchListGui(this, manager, settings));
    ...
    protected Collection<Pair<TableColumn<SnitchList>, Boolean>> initializeColumns() {
        ...
        columns.add(packageValues(new SnitchListRemoveColumn(manager), false));
        ...
        if (settings.getSnitchColumns() == null || settings.getSnitchColumns().isEmpty()) {
            ...
            final List<Pair<String, Boolean>> entries = settings.getSnitchListColumns();
    ...
    private final TableButtonColumn.OnButtonClick<SnitchList> viewSnitchesClick = new TableButtonColumn.OnButtonClick<SnitchList>() {
        ...
        public void onClick(SnitchList list, GuiButton button, GuiScreen parentScreen) {
            ...
            if (snitches.isEmpty()) {
                ...
                mc.displayGuiScreen(new SnitchesTable(parentScreen, snitches,
                        "Snitches for Snitch List: " + list.getName(), manager, settings,
                        JourneyMapRelay.getInstance()));
            }
        }
    };
