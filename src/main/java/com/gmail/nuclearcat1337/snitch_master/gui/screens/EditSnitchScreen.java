...
public class EditSnitchScreen extends GuiScreen {
    ...
    public EditSnitchScreen(Snitch snitch, SnitchManager snitchManager, JourneyMapInterface journeyMapInterface,
                            WorldProvider worldProvider, GuiScreen previousScreen) {
        this.snitch = snitch;
    ...
    public void actionPerformed(GuiButton button) {
        ...
        if (button.id == 1) {
            ...
            if (onConfirmationButton) {
                ...
                journeyMapInterface.refresh(snitchManager.getSnitches());
