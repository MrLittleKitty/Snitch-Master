...
public class NewSnitchListGui extends GuiScreen {
    ...
    public NewSnitchListGui(final GuiScreen cancelToScreen, final SnitchManager manager, final Settings settings) {
    ...
    public void actionPerformed(GuiButton button) {
        switch (button.id) {
            ...
            case 2:
                ...
                this.mc.displayGuiScreen(new SnitchListsTable(null, manager.getSnitchLists(),
